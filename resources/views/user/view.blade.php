                                            ...
                                            <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-title="Photo">
                                                            <img src={{$user->profile_photo_path}} width="35px" height="35px" class="img-rounded" alt="" />
                                                        </td>
                                                        <td data-title="Name">{{$user->name}}</td>
                                                        <td data-title="Email">{{$user->email}}</td>

                                                        <td data-title="Action">
                                                            <a href="{{route('user.show',$user)}}" class="btn btn-success btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View"><i class="fa fa-check-square-o"></i></a>
                                                            <a href="{{route('user.edit',$user)}}" class="btn btn-warning btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                ...
                                <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="Photo">
                                                <img src={{$pr -> profile_photo_path}} width="35px" height="35px" class="img-rounded" alt="" />
                                            </td>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h5 class="page-header"><a href="add-teacher"><i class="fa fa-plus"></i>
                                    Add a teacher</a>
                            </h5>
